...
function [MeanGlycation MaxGlycation SpreadGlycation MeanNumberofGlucoseFeeds MaxNumberofGlucoseFeeds]=Model(x);
% 
...
figure
subplot(4,3,1)
hist(NumberofGlucoseFeeds)
subplot(4,3,2)
bar(mean(NumberofGlucoseFeeds))
subplot(4,3,3)
bar(std(NumberofGlucoseFeeds))


subplot(4,3,4)
hist(FinalGlycation)
subplot(4,3,5)
bar(mean(FinalGlycation))
subplot(4,3,6)
bar(std(FinalGlycation))
...
subplot(4,3,10)
plot(Time,ProteinConcentration)
subplot(4,3,11)
hist(NumberofGlucoseFeeds)
